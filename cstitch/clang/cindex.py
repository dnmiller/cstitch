...
from ctypes import (
    POINTER, c_void_p, c_char_p, c_uint, c_int, Structure, byref, c_longlong,
    cast, c_ulong, c_ulonglong, py_object, CFUNCTYPE, cdll)
import collections
...
class StorageClass(object):
    ...
    def __init__(self, value):
        if value >= len(StorageClass._kinds):
            StorageClass._kinds += \
                [None] * (value - len(StorageClass._kinds) + 1)
...
class TranslationUnit(ClangObject):
    ...
    def from_source(cls, filename, args=None, unsaved_files=None, options=0,
        ...
        ptr = conf.lib.clang_parseTranslationUnit(
            index, filename, args_array, len(args), unsaved_array,
